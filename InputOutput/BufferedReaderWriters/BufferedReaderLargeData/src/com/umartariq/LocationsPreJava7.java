 ...
 */
public class LocationsPreJava7 implements Map<Integer, Location> {
    private static Map<Integer, Location> locations = new HashMap<Integer, Location>();

    static {

        //executed when class is loaded, exceptions cant be catched.
        //we can throw only unchecked exceptions in an initialization block.
