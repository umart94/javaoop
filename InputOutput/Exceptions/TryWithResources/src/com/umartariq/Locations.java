...
public class Locations implements Map<Integer,Location> {
    ...
    public static void main(String[] args) throws IOException{
        ...
        //Module Settings -> choose v7 , v7 allows the multi catch setting shown here.

        //the try block in java v7 allows us to automatically ensure that filewriter is closed
        //whether we catch it or not.
        try(FileWriter locationsFile = new FileWriter("locations.txt")) {
            ...
            //catch / finally block not needed.
         }
    }
