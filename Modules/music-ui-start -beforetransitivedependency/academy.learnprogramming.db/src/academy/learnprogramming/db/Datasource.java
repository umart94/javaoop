...
when we created this second module, these import statements will have to be changed manually
inside the module-info file for this module.

this will give an error that module is not in the dependencies academy.learnprogramming.common


now we can add these import statements back

import academy.learnprogramming.common.Album;
import academy.learnprogramming.common.Artist;

but we also need to add the exports statements. to module-info.java
...
public class Datasource {
    ...
    private static final String DB_NAME = "music.db";
      ...
      // "jdbc:sqlite:D:\\github\\programming\\javaoop\\Modules\\music-ui-start\\" + DB_NAME;
