...
MyClass myVar = MyClass
  ...
  /*          int pw = 7534;
        ...
        ExtendedPassword password = new ExtendedPassword(pw);//Revert this back.
        ...
        //Note that static initialization blocks are called before the constructor.
        //This is how we should initialize, and declare, and define the static final variables. in our code.
        //before the main method ( static final variables )
        /*
        ^^output
        Main method called
